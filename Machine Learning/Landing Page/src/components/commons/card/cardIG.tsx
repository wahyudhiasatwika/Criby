...
export default function CardIg({
    ...
    return (
        <div className="bg-white border rounded-sm max-w-md">
            <div className="flex items-center px-4 py-3">
                {/* <img className="h-8 w-8 rounded-full" src="/image/test.png" /> */}
                <div className="ml-3 ">
                    <span className="text-sm font-semibold antialiased block leading-tight">{member}</span>
                    <span className="text-gray-600 text-xs block">{description}</span>
                </div>
            </div>
